...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button registrar = (Button) findViewById(R.id.btn_registrarse);
        ...
        loginClave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Por si no llena los datos
                if (emailTexto.isEmpty() && claveTexto.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Usted aun no ha colocado su correo, ni la clave.", Toast.LENGTH_SHORT).show();
                } else if (emailTexto.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Usted aun no ha colocado su correo", Toast.LENGTH_SHORT).show();
                } else if (claveTexto.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Usted aun no ha colocado su clave.", Toast.LENGTH_SHORT).show();
                } else {
                    //Inicia seccion si tiene correo y clave
        ...
        registrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, AgregarPersonas.class);
